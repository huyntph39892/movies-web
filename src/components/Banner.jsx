      ...
      <div className="w-full h-full flex items-center justify-center space-x-[30px] p-4 relative z-20">
        <div className="flex flex-col space-y-5 items-baseline w-[50%]">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div>
              <p className="text-white">Cám là bộ phim chiếu rạp tháng 9/2024 thuộc thể loại kinh dị, giật gân được chuyển thể từ truyện cổ tích "Tấm Cám" với tên gọi cũ là Con Cám. Đạo diễn đã xây dựng một cốt truyện đầy ghê rợn và các thủ tục mà chỉ nghe thôi cũng phải sởn gai ốc. Ngay từ khi hé lộ trailer, Cám đã thu hút rất nhiều sự chú ý của khán giả đến từ dàn cast cũng như hình ảnh hậu trường đầy kinh dị. Trước khi đi vào diễn biến của phim, mời các bạn xem qua một số thông tin chính của phim.</p>
              <div className="flex items-center space-x-4">
                <button className="p-2 text-white bg-red-700 font-bold text-sm">Chi tiết</button>
                <button className="p-2 text-white bg-red-700 font-bold text-sm">Xem phim</button>
              </div>
            </div>
          </div>
        </div>
